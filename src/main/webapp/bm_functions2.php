...
function change_password($username, $old_password, $new_password) {
    ...
    $conn = db_connect();
    $result = $conn->query("update user set passwd = sha1('".$new_password."')where username = '".$username."'");//sha1()使用美国的Secure Hash算法来加密的
    if (!$result) {
...
// and return it
    ...
    $word = '';
    $dictionary = 'C:\\phpStudy\\PHPTutorial\\words';  // 文件目录
